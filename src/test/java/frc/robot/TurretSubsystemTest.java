...
public class TurretSubsystemTest {
  ...
  public void testInitialAngle_isZeroDegrees() {
    assertEquals(0.0, m_turret.getTurretAngleDegrees(), 0.01,
        "Turret should start at 0 degrees in sim");
  }

  @Test
  public void testInitialAngleRadians_isZero() {
    assertEquals(0.0, m_turret.getTurretAngleRadians(), 1e-6,
        "Turret should start at 0 radians in sim");
  }
  ...
  public void testIsAtAngle_atStart_zeroWithWideTolerance() {
    assertTrue(m_turret.isAtAngle(0.0, 5.0),
  ...
  public void testIsAtAngle_notAtAngle_withNarrowTolerance() {
    ...
    assertFalse(m_turret.isAtAngle(45.0, 1.0),
  ...
  public void testSetTurretSpeed_belowDeadzone_treatedAsZero() {
    ...
    assertDoesNotThrow(() -> m_turret.setTurretSpeed(0.05),
        "Sub-deadzone input must be handled gracefully");
  }
  ...
  public void testSetTargetAngle_doesNotThrow() {
    assertDoesNotThrow(
        () -> m_turret.setTargetAngle(90.0), "setTargetAngle(90) must not throw");
  }
  ...
  public void testSimulationPeriodic_doesNotThrow() {
    assertDoesNotThrow(
        () -> m_turret.simulationPeriodic(), "simulationPeriodic() must not throw");
  }
  ...
  public void testSimulationPeriodic_updatesPhysics() {
    ...
    for (int i = 0; i < 5; i++) {
      assertDoesNotThrow(() -> m_turret.simulationPeriodic(),
