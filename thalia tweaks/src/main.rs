...
fn default_tweaks() -> Vec<Tweak> {
    vec![
        Tweak { name: "Enable Tuning Mode",               id: "TUNING_MODE",                       state: false },
        Tweak { name: "Limit Drive Speed to 75%",         id: "LIMIT_DRIVE_SPEED_TO_75",           state: false },
        Tweak { name: "Invert Drive Controls",            id: "INVERT_DRIVE_CONTROLS",             state: false },
        Tweak { name: "Boost Mode Override",              id: "BOOST_MODE_OVERRIDE",               state: false },
        Tweak { name: "Slow Mode Modifier Active",        id: "SLOW_MODE_MODIFIER_ACTIVE",         state: false },
        Tweak { name: "Enable Dynamic Braking",           id: "ENABLE_DYNAMIC_BRAKING",            state: true  },
        Tweak { name: "Enable LED Diagnostics",           id: "ENABLE_LED_DIAGNOSTICS",            state: true  },
        Tweak { name: "Record Telemetry to USB",          id: "RECORD_TELEMETRY_TO_USB",           state: true  },
        Tweak { name: "Mute Dashboard Alerts",            id: "MUTE_DASHBOARD_ALERTS",             state: false },
        Tweak { name: "Enable Pit Health Check",          id: "ENABLE_PIT_HEALTH_CHECK_ON_START",  state: true  },
        Tweak { name: "Enable Turret Unwind",             id: "ENABLE_TURRET_UNWIND",              state: true  },
        Tweak { name: "Use Rust Lead Calculator",         id: "USE_RUST_LEAD_CALCULATOR",          state: true  },
        Tweak { name: "Allow Fire While Moving",          id: "ALLOW_FIRE_WHILE_MOVING",           state: false },
        Tweak { name: "Disable Intake During Fire",       id: "DISABLE_INTAKE_DURING_FIRE",        state: true  },
        Tweak { name: "Smooth Loader Motors",             id: "SMOOTH_LOADER_MOTORS",              state: true  },
        Tweak { name: "Use Profiled PID For Turret",      id: "USE_PROFILED_PID_FOR_TURRET",       state: true  },
        Tweak { name: "Reverse Turret Direction",         id: "REVERSE_TURRET_DIRECTION",          state: false },
        Tweak { name: "Disable Brownout Protection",      id: "DISABLE_BROWNOUT_PROTECTION",       state: false },
        Tweak { name: "Enable Stall Detection",           id: "ENABLE_STALL_DETECTION",            state: true  },
        Tweak { name: "Ignore Limit Switches",            id: "IGNORE_LIMIT_SWITCHES",             state: false },
        Tweak { name: "Testing Mode Bypass Sensors",      id: "TESTING_MODE_BYPASS_SENSORS",       state: false },
        Tweak { name: "Override Battery Sense",           id: "OVERRIDE_BATTERY_SENSE",            state: false },
        Tweak { name: "Enable Haptic Feedback",           id: "ENABLE_HAPTIC_FEEDBACK",            state: true  },
        Tweak { name: "Force Red Alliance Mode",          id: "FORCE_RED_ALLIANCE_MODE",           state: false },
        Tweak { name: "Battery Sagging Alert",            id: "BATTERY_SAGGING_ALERT",             state: true  },
        Tweak { name: "Ignore Spinup Time",               id: "IGNORE_SPINUP_TIME",                state: false },
        Tweak { name: "Auto Home Turret On Disable",      id: "AUTO_HOME_TURRET_ON_DISABLE",       state: true  },
        Tweak { name: "Display Birdseye Map Dashboard",   id: "DISPLAY_BIRDSEYE_MAP_DASHBOARD",    state: true  },
        Tweak { name: "Fast Boot Rio Mode",               id: "FAST_BOOT_RIO_MODE",                state: false },
    ]
}
    ...
    fn draw_tweaks(&mut self, ui: &mut Ui) {
        ...
        egui::ScrollArea::vertical().show(ui, |ui| {
            egui::Grid::new("tweaks_grid")
                ...
                .min_col_width(210.0)
                .show(ui, |ui| {
                    for (i, tweak) in self.tweaks.iter_mut().enumerate() {
                        ...
                        let text_origin = rect.min + egui::vec2(12.0, 8.0);
                        painter.text(
                            text_origin,
                        ...
                        painter.text(
                            text_origin + egui::vec2(0.0, 16.0),
                            egui::Align2::LEFT_TOP,
                            tweak.name,
